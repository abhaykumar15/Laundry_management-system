...
//    HttpServlet response;
    ...
    private void processOrderAcceptance(int orderId, int studentId, Employee emp, LaundaryDao dao, PrintWriter out) throws Exception {
        LaundaryOrder order = dao.getOrderById(orderId);
